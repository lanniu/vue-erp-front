...
export default {
  ...
  computed: {
    ...
    updateModelMsgCountNumber: {
      get () {
        return this.$store.state.user.modelMsgCountNumber
      },
      set (val) {
        this.$store.commit('user/updateModelMsgCountNumber', val)
      }
    },
    updateSimpleName: {
      get () {
        return this.$store.state.user.simpleName
      },
      set (val) {
        this.$store.commit('user/updateSimpleName', val)
      }
    ...
    getUserInfo () {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.updateSimpleName = data.user.realName
        }
      })
    },
